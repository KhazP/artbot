...
export interface ReportRecord {
  ...
  normalized_price_eur?: number | null;
  normalized_price_usd_nominal?: number | null;
  normalized_price_eur_nominal?: number | null;
  normalized_price_usd_2026?: number | null;
  normalized_price_eur_2026?: number | null;
  original_amount_raw?: string | null;
  original_currency_raw?: string | null;
  original_currency_canonical?: string | null;
  original_event_date?: string | null;
  date_confidence?: string;
  currency_interpretation_confidence?: number | null;
  ...
  normalization_confidence_score?: number | null;
